...
def main(args):
    ...
    save_image(samples, "./outputs/sample_{}.png".format(args.gpt_type), nrow=4, normalize=True, value_range=(-1, 1))
    print(f"image is saved to ./outputs/sample_{args.gpt_type}.png")
